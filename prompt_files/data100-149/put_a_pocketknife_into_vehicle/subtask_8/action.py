...
def act(robot,env,camera):
    ...
    # Since the previous attempt to move to "location_3" failed, we will try to move to a different location, "location_4".
    location_4 = registry(env,"location_4")
    MoveBot(env, robot, location_4, camera)
    donothing(env)
