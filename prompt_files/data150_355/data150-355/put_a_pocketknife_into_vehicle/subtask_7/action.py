...
def act(robot,env,camera):
    ...
    # Since the previous attempt to move to "location_2" failed, we will try to move to a different location, "location_3".
    location_3 = registry(env,"location_3")
    MoveBot(env, robot, location_3, camera)
    donothing(env)
