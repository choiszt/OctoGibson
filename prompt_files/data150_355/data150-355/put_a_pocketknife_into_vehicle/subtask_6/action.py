...
def act(robot,env,camera):
    ...
    # Since the previous attempt to move to "location_1" failed, we will try to move to a different location, "location_2".
    location_2 = registry(env,"location_2")
    MoveBot(env, robot, location_2, camera)
    donothing(env)
